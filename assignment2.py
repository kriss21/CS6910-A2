...
# keras.backend.clear_session()
# model = cnn_model((128,128,3))
# model.add_cnn_block(nfilters=16,filter_size=(7,7),batch_norm="yes")
# model.add_cnn_block(nfilters=32,filter_size=(5,5),batch_norm="yes")
# model.add_cnn_block(nfilters=64,filter_size=(5,5),batch_norm="yes")
# model.add_cnn_block(nfilters=128,filter_size=(3,3),batch_norm="yes")
# model.add_cnn_block(nfilters=512,filter_size=(2,2),batch_norm="yes")
# model.add_dense_layer(1024)
# training = model.build_model(10,lr=1e-6)


# In[14]:


# training.fit(train_generator,
